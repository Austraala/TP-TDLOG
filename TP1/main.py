...
def print_line():
    """ We print the beginning or ending line """
    print("     +-----|-----+")
...
def print_domino(domino_list):
    """ We print a domino list """
    for i, domino in enumerate(domino_list):
        # We generate the lines of the domino
        left_line_1, left_line_2, left_line_3 = create_str_domino(domino[0])
        right_line_1, right_line_2, right_line_3 = create_str_domino(domino[1])
...
def check_defeat(sum_domino_hand, objective):
    ...
    for i in range(len(sum_domino_hand)):
        ...
        sum_domino_hand_recursive = [sum_domino_hand[j] for j, sum_domino in enumerate(sum_domino_hand) if j != i]
